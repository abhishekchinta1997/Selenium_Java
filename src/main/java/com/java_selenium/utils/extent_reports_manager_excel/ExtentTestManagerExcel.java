...
public class ExtentTestManagerExcel
{
    ...
    public static ExtentTest CreateParentTest(String testName)
    {
        ...
        {
            ExtentTest test = ExtentManagerExcel.getInstance().createTest(testName);
            parentTest.set(test);
    ...
    public static ExtentTest CreateTest(String parentName, String testName)
    {
        synchronized (synclock)
        {
            ...
            {
                parentTestInstance = ExtentManagerExcel.getInstance().createTest(parentName);
