...
public class ExtentManager
{
    ...
    static {
        ...
        if (workingDirectory != null)
        {
            ...
            htmlReporter.config().setDocumentTitle("Extent/Reports");  // Set the document title
            htmlReporter.config().setReportName("Extent/Reports");    // Set the report name
            ...
            INSTANCE.setSystemInfo("Application", "E Commerce Project");
